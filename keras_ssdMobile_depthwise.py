...
def ssd_Mobilenet(image_size,
    ...
    '''
    Build a Keras model with SSD300_MobileNet architecture, see references.
    ...
    Returns:
        model: The Keras SSD300_MobileNet model.
    ...
    References:
        SSD architecture: https://arxiv.org/abs/1512.02325v5
        MobileNet SSD: https://arxiv.org/abs/1611.10012v3
    '''
    ...
    ############################################################################
    # Define initializer of weights according to paper.
    ############################################################################

    def my_init(shape, dtype=None):
        return K.truncated_normal(stddev=0.03, shape=shape, dtype=dtype)
    ...
    conv0 = Conv2D(32, (3,3), strides=(2,2), padding='same', kernel_initializer=my_init, kernel_regularizer=l2(l2_reg), name='conv0')(x1)
    conv0 = BatchNormalization(momentum=0.99, name='bn0')(conv0)
    conv0 = Activation(relu6)(conv0)

    conv1dw = DepthwiseConv2D((3,3), padding='same', name='conv1dw')(conv0)
    conv1dw = BatchNormalization(momentum=0.99, name='bn1dw')(conv1dw)
    conv1dw = Activation(relu6)(conv1dw)
    conv1 = Conv2D(64, (1,1), padding='same', kernel_initializer=my_init, name='conv1')(conv1dw)
    conv1 = BatchNormalization(momentum=0.99, name='bn1')(conv1)
    conv1 = Activation(relu6)(conv1)

    conv2dw = DepthwiseConv2D((3,3), strides=(2,2), padding='same', name='conv2dw')(conv1)
    conv2dw = BatchNormalization(momentum=0.99, name='bn2dw')(conv2dw)
    conv2dw = Activation(relu6)(conv2dw)
    conv2 = Conv2D(128, (1,1), padding='same', kernel_initializer=my_init, name='conv2')(conv2dw)
    conv2 = BatchNormalization(momentum=0.99, name='bn2')(conv2)
    conv2 = Activation(relu6)(conv2)

    conv3dw = DepthwiseConv2D((3,3), padding='same', name='conv3dw')(conv2)
    conv3dw = BatchNormalization(momentum=0.99, name='bn3dw')(conv3dw)
    conv3dw = Activation(relu6)(conv3dw)
    conv3 = Conv2D(128, (1,1), padding='same', kernel_initializer=my_init, name='conv3')(conv3dw)
    conv3 = BatchNormalization(momentum=0.99, name='bn3')(conv3)
    conv3 = Activation(relu6)(conv3)

    conv4dw = DepthwiseConv2D((3,3), strides=(2,2), padding='same', name='conv4dw')(conv3)
    conv4dw = BatchNormalization(momentum=0.99, name='bn4dw')(conv4dw)
    conv4dw = Activation(relu6)(conv4dw)
    conv4 = Conv2D(256, (1,1), padding='same', kernel_initializer=my_init, name='conv4')(conv4dw)
    conv4 = BatchNormalization(momentum=0.99, name='bn4')(conv4)
    conv4 = Activation(relu6)(conv4)

    conv5dw = DepthwiseConv2D((3,3), padding='same', name='conv5dw')(conv4)
    conv5dw = BatchNormalization(momentum=0.99, name='bn5dw')(conv5dw)
    conv5dw = Activation(relu6)(conv5dw)
    conv5 = Conv2D(256, (1,1), padding='same', kernel_initializer=my_init, name='conv5')(conv5dw)
    conv5 = BatchNormalization(momentum=0.99, name='bn5')(conv5)
    conv5 = Activation(relu6)(conv5)

    conv6dw = DepthwiseConv2D((3,3), strides=(2,2), padding='same', name='conv6dw')(conv5)
    conv6dw = BatchNormalization(momentum=0.99, name='bn6dw')(conv6dw)
    conv6dw = Activation(relu6)(conv6dw)
    conv6 = Conv2D(512, (1,1), padding='same', kernel_initializer=my_init, name='conv6')(conv6dw)
    conv6 = BatchNormalization(momentum=0.99, name='bn6')(conv6)
    conv6 = Activation(relu6)(conv6)

    # Repeat 5 times
    conv7dw = DepthwiseConv2D((3,3), padding='same', name='conv7dw')(conv6)
    conv7dw = BatchNormalization(momentum=0.99, name='bn7dw')(conv7dw)
    conv7dw = Activation(relu6)(conv7dw)
    conv7 = Conv2D(512, (1,1), padding='same', kernel_initializer=my_init, name='conv7')(conv7dw)
    conv7 = BatchNormalization(momentum=0.99, name='bn7')(conv7)
    conv7 = Activation(relu6)(conv7)

    conv8dw = DepthwiseConv2D((3,3), padding='same', name='conv8dw')(conv7)
    conv8dw = BatchNormalization(momentum=0.99, name='bn8dw')(conv8dw)
    conv8dw = Activation(relu6)(conv8dw)
    conv8 = Conv2D(512, (1,1), padding='same', kernel_initializer=my_init, name='conv8')(conv8dw)
    conv8 = BatchNormalization(momentum=0.99, name='bn8')(conv8)
    conv8 = Activation(relu6)(conv8)

    conv9dw = DepthwiseConv2D((3,3), padding='same', name='conv9dw')(conv8)
    conv9dw = BatchNormalization(momentum=0.99, name='bn9dw')(conv9dw)
    conv9dw = Activation(relu6)(conv9dw)
    conv9 = Conv2D(512, (1,1), padding='same', kernel_initializer=my_init, name='conv9')(conv9dw)
    conv9 = BatchNormalization(momentum=0.99, name='bn9')(conv9)
    conv9 = Activation(relu6)(conv9)

    conv10dw = DepthwiseConv2D((3,3), padding='same', name='conv10dw')(conv9)
    conv10dw = BatchNormalization(momentum=0.99, name='bn10dw')(conv10dw)
    conv10dw = Activation(relu6)(conv10dw)
    conv10 = Conv2D(512, (1,1), padding='same', kernel_initializer=my_init, name='conv10')(conv10dw)
    conv10 = BatchNormalization(momentum=0.99, name='bn10')(conv10)
    conv10 = Activation(relu6)(conv10)

    conv11dw = DepthwiseConv2D((3,3), padding='same', name='conv11dw')(conv10)
    conv11dw = BatchNormalization(momentum=0.99, name='bn11dw')(conv11dw)
    conv11dw = Activation(relu6)(conv11dw)
    conv11 = Conv2D(512, (1,1), padding='same', kernel_initializer=my_init, name='conv11')(conv11dw)
    conv11 = BatchNormalization(momentum=0.99, name='bn11')(conv11)
    conv11 = Activation(relu6)(conv11)

    # So far, (19, 191 512) following 2 
    conv12dw = DepthwiseConv2D((3,3), strides=(2,2), padding='same', name='conv12dw')(conv11)
    conv12dw = BatchNormalization(momentum=0.99, name='bn12dw')(conv12dw)
    conv12dw = Activation(relu6)(conv12dw)
    conv12 = Conv2D(1024, (1,1), padding='same', kernel_initializer=my_init, name='conv12')(conv12dw)
    conv12 = BatchNormalization(momentum=0.99, name='bn12')(conv12)
    conv12 = Activation(relu6)(conv12)

    conv13dw = DepthwiseConv2D( (3,3), padding='same', name='conv13dw')(conv12) # NOT strides=(2,2) as original network in paper
    conv13dw = BatchNormalization(momentum=0.99, name='bn13dw')(conv13dw)
    conv13dw = Activation(relu6)(conv13dw)
    conv13 = Conv2D(1024, (1,1), padding='same', kernel_initializer=my_init, name='conv13')(conv13dw)
    conv13 = BatchNormalization(momentum=0.99, name='bn13')(conv13)
    conv13 = Activation(relu6)(conv13)

    # Backbone network ends, follwoing are four additional conv layers

    conv14_1 = Conv2D(256, (1,1), padding='same', kernel_initializer=my_init, name='conv14_1')(conv13)
    conv14_1 = BatchNormalization(momentum=0.99, name='bn14_1')(conv14_1)
    conv14_1 = Activation(relu6)(conv14_1)
    conv14_2 = Conv2D(512, (3,3), strides=(2,2), padding='same', kernel_initializer=my_init, name='conv14_2')(conv14_1)
    conv14_2 = BatchNormalization(momentum=0.99, name='bn14_2')(conv14_2)
    conv14_2 = Activation(relu6)(conv14_2)

    conv15_1 = Conv2D(128, (1,1), padding='same', kernel_initializer=my_init, name='conv15_1')(conv14_2)
    conv15_1 = BatchNormalization(momentum=0.99, name='bn15_1')(conv15_1)
    conv15_1 = Activation(relu6)(conv15_1)
    conv15_2 = Conv2D(256, (3,3), strides=(2,2), padding='same', kernel_initializer=my_init, name='conv15_2')(conv15_1)
    conv15_2 = BatchNormalization(momentum=0.99, name='bn15_2')(conv15_2)
    conv15_2 = Activation(relu6)(conv15_2)

    conv16_1 = Conv2D(128, (1,1), padding='same', kernel_initializer=my_init, name='conv16_1')(conv15_2)
    conv16_1 = BatchNormalization(momentum=0.99, name='bn16_1')(conv16_1)
    conv16_1 = Activation(relu6)(conv16_1)
    conv16_2 = Conv2D(256, (3,3), strides=(2,2), padding='same', kernel_initializer=my_init, name='conv16_2')(conv16_1)
    conv16_2 = BatchNormalization(momentum=0.99, name='bn16_2')(conv16_2)
    conv16_2 = Activation(relu6)(conv16_2)

    conv17_1 = Conv2D(64, (1,1), padding='same', kernel_initializer=my_init, name='conv17_1')(conv16_2)
    conv17_1 = BatchNormalization(momentum=0.99, name='bn17_1')(conv17_1)
    conv17_1 = Activation(relu6)(conv17_1)
    conv17_2 = Conv2D(128, (3,3), strides=(2,2), padding='same', kernel_initializer=my_init, name='conv17_2')(conv17_1)
    conv17_2 = BatchNormalization(momentum=0.99, name='bn17_2')(conv17_2)
    conv17_2 = Activation(relu6)(conv17_2)
